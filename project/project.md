...
- [ ] Please fix the reference section. It is not properly organized. One line should only have a single reference.
- [ ] Please use a proper editor you ofte have strange non Ascii chars in your document. WHatever editor you use does not work, or you convert a file wrong when editing.
